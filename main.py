...
cap = cv2.VideoCapture(sys.argv[1] or 'edited.mp4')
...
class findContours(fgmask,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE):
...
class randn(noise, np.zeros(3), np.ones(3)*255*self.noise):
